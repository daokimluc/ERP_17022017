...
app.controller('khoCtrl', function ($scope, $http) {
    ...
    $scope.add = function () {
        ...
        $http.post("/api/Api_KhoHL", data_add).then(function (response) {
            $scope.get_kho();
    ...
    $scope.save = function (makho) {
        ...
        $http.put("/api/Api_KhoHL/" + makho, data_update).then(function (response) {
            $scope.get_kho();
    ...
    $scope.delete = function (makho) {
        ...
        $http.delete("/api/Api_KhoHL/" + makho, data_delete)
            .then(function (response) {
                $scope.get_kho();
            });
    }
