...
function hangHoaCtrl($scope, $http)
{
    ...
    $scope.add = function () {
        ...
        $http.post("/api/Api_HanghoaHL", data_add).then(function (response) {
            $scope.get_hanghoa();
    ...
    $scope.save = function (mahanght) {
        ...
        $http.put("/api/Api_HanghoaHL/" + mahanght, data_update).then(function (response) {
            $scope.get_hanghoa();
    ...
    $scope.delete = function (mahanght) {
        ...
        $http.delete("/api/Api_HanghoaHL/" + mahanght, data_delete)
            .then(function (response) {
                $scope.get_hanghoa();
            });
    }
