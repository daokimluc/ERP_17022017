...
function phongbanCtrl($scope, $http) {
    ...
    $scope.add = function () {
        ...
        $http.post("/api/Api_PhongbanTAHCM", data_add).then(function (response) {
            $scope.get_phongban();
            $scope.maphongban ="";
            $scope.tenphongban ="";
            $scope.sdt ="";
    ...
    $scope.save = function (phongban) {
        ...
        $http.put("/api/Api_PhongbanTAHCM/" + phongban, data_update).then(function (response) {
            $scope.get_phongban();
    ...
    $scope.delete = function (phongban) {
        ...
        $http.delete("/api/Api_PhongbanTAHCM/" + phongban, data_delete)
            .then(function (response) {
                $scope.get_phongban();
            });
    }
